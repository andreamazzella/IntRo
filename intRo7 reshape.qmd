...
```{r import_data}
site5 <- read_excel("data/candidaemias.xlsx", sheet = "site5")
site7 <- read_excel("data/candidaemias.xlsx", sheet = "site7")
site8 <- read_excel("data/candidaemias.xlsx", sheet = "site8")
cfupcr <- read_excel("data/candidaemias.xlsx", sheet = "cfupcr")
demographics <- read_excel("data/candidaemias.xlsx", sheet = "demographics")
meds <- read_excel("data/candidaemias.xlsx", sheet = "meds")
outcomes <- read_excel("data/candidaemias.xlsx", sheet = "outcomes")
```
...
In order to turn the `hours` column into a numeric class we need to first remove the now unneeded "bdg_" prefix - we can do this by adding a `names_prefix =` argument:
