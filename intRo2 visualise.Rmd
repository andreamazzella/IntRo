...
Write some code to calculate the median tooth length in the dataframe `ToothGrowth`.
...
Bar charts are useful to visualise frequencies of a categorical variable, such as diet type in our dataset (`vore`).
...
In computer science a "vector" is an ordered list containing objects of the same data type.

In R, you create a vector with function `c()` -- which stands for "concatenate" or "combine".
