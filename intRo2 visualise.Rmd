...
Calculate the median tooth length in the dataframe `ToothGrowth`.
...
Package `ggplot2` can make stunning graphs.
...
In R, you create a vector with function `c()` -- which stands for "combine".
...
Vectors are often used when:

- we want to apply a function to more than one object,
