...
* Package [`here`](https://here.r-lib.org/) helps referencing file paths - useful when importing and exporting objects as files.
* Package [`rio`](https://github.com/leeper/rio) lets you import and export with only two functions, regardless of file format.
