...
*Exercise 5.* 1. Import the `bristol.rds` dataset. 2. Explore the data. 2. Categorise the type of stool in the Bristol scale into three levels: "constipation" (type 1-2), "normal" (type 3-5), "diarrhoea" (type 6-7). 3. Save a copy as `bristol_v2.rds`.
