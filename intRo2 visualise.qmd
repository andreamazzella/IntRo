...
Before you run this chunk, ensure you have installed the `readr` and `ggplot2` packages.
...
Calculate the minimum white blood cell count in the dataframe `bacteraemias`.
...
Create a chunk below and use it to create a new object called "min_white" that contains this value.
