...
-  Create a new variable with three levels: eats meat, eats fish, doesn't eat either, using `diet` as reference.
-  Create a new binary variable that indicates whether a patient is inactive, using `exercise` as reference.
